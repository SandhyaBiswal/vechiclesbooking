...
const TruckDetals = () => {
  ...
  // const {truckName}=props.item

  const singleCarItem = truckData.find((item) => item.truckName === slug);
  ...
  return (
    <Helmet title={singleCarItem.truckName}>
      <section>
        <Container>
          <Row>
            <Col lg="6">
            ...
            <Col lg="6">
              <div className="truck_info">
                <h2 className="section_title">{singleCarItem.truckName}</h2>
